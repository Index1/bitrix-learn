...
// TODO Component
// Use Bitrix\Main\Context for optimizate;
/*$request = Context::getCurrent()->getRequest();

if($request->getQuery('argListOfJobs') == 'myListOfJobs' && ($USER->IsAdmin() || CSite::InGroup(5)))
    $arrFilter[] = array('IBLOCK_ID' => $arParams["IBLOCK_ID"], 'CREATED_BY' => $USER->GetID(), 'ACTIVE' => 'Y');*/
